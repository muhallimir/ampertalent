...
export const JOB_CATEGORIES = [
  ...
  'Design', 'Operations', 'Legal', 'Healthcare', 'Education',
  // + 18 more = 28 total
];

export const JOB_TYPES = [
  'Full-time', 'Part-time', 'Freelance', 'Contract', 'Temporary'
];
...
export const BENEFITS = [
  'Health Insurance', '401k', 'Remote', 'Flexible Hours', 'PTO',
  'Stock Options', 'Bonus', 'Professional Development'
];
```
...
it('should generate presigned upload URL', async () => {
  const url = await generatePresignedUploadUrl('resumes', 'user-123/resume.pdf');
